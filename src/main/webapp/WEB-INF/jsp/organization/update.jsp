...
<div class="panel panel-default">
  <div class="panel-heading">更新机构</div>
  <div class="panel-body">
    <form class="form-horizontal" id="updateOrganiztionForm" action="${ctx}/organiztion/create-form">
      <div class="form-group">
        <label for="create-organiztion-name" class="col-sm-2 control-label" maxlength="20" minlength="2">机构名称</label>
        <div class="col-sm-10">
          <input name="uuid" type="hidden" value="0">
  ...
  <div class="panel-footer text-right">
    <a href="javascript:organization.submitUpdateForm()" class="btn btn-default btn-sm" role="button">
      <span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span> 保 存
    </a>
    <a href="javascript:modalUtil.close('#updateOrganizationModal')" class="btn btn-primary btn-sm" role="button">
