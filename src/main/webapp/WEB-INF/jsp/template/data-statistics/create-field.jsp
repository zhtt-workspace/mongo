...
<div class="panel panel-default">
  ...
  <div class="panel-footer text-right">
    ...
    <a href="javascript:modalUtil.close('#createFieldDataStatisticsTemplateModal')" class="btn btn-primary btn-sm crete-close-btn" role="button">
      <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> 关 闭
    </a>
    <a href="javascript:modalUtil.close('#updateFieldDataStatisticsTemplateModal')" class="btn btn-primary btn-sm crete-close-btn hide" role="button">
      <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> 关 闭
    </a>
  </div>
</div>