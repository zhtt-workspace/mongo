  ...
  <div class="panel-body">
    <form class="form-horizontal" id="updateUserForm" action="${ctx}/user/update-form" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <input name="name" type="text" class="form-control" id="update-user-name" placeholder="姓名">
        </div>
      </div>
      <div class="form-group">
        <label for="update-user-username" class="col-sm-2 control-label">用户名</label>
        <div class="col-sm-10">
          <input name="username" type="text" class="form-control" id="update-user-username" placeholder="用户名">
        </div>
      </div>
      <div class="form-group">
        <label for="update-user-password" class="col-sm-2 control-label">密码</label>
        <div class="col-sm-10">
          <input name="password" type="password" class="form-control" id="update-user-password" placeholder="密码">
        </div>
      </div>
      <div class="form-group">
        <label for="update-user-password" class="col-sm-2 control-label">密码确认</label>
        <div class="col-sm-10">
          <input type="password" class="form-control" id="update-user-password1" placeholder="密码确认">
        </div>
      </div>
      <div class="form-group">
        <label for="update-user-age" class="col-sm-2 control-label">年龄</label>
        <div class="col-sm-10">
          <input name="age" type="text" class="form-control" id="update-user-age" placeholder="年龄">
        </div>
      </div>
      <div class="form-group">
        <label for="update-user-org" class="col-sm-2 control-label">所属机构</label>
        <div class="col-sm-10">
          <input name="orgId" type="text" class="form-control" id="update-user-org" placeholder="所属机构">
        </div>
      </div>
    </form>
  </div>
